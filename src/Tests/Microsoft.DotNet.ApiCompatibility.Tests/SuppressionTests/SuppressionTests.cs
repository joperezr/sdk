...
namespace Microsoft.DotNet.ValidationSuppression.Tests
{
    public class SuppressionTests
    {
        ...
        public static IEnumerable<object[]> GetDifferentData()
        {
            ...
            yield return new object[] { new Suppression { DiagnosticId = "PK004", Target = "A.B", Left = "ref/net6.0/myLib.dll", Right = "lib/net6.0/myLib.dll", IsBaselineSuppression = true }, new Suppression { DiagnosticId = "PK004", Target = "A.B", Left = "ref/net6.0/myLib.dll", Right = "lib/net6.0/myLib.dll" } };
